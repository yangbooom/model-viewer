(function () {
    ...
    const WARNING_MESSAGE = 'Candidate image is semi-transparent, probably the screenshot was taken before the poster faded away!';
    class ImageComparator {
        ...
        analyze(checkSemiTransparent = true) {
            const { candidateImage, goldenImage } = this;
            const { width, height } = this.dimensions;
            let squareSum = 0;
            if (candidateImage.length != goldenImage.length) {
